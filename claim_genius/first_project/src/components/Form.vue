  ...
  <form @submit.prevent="submitForm">
      <div>
        <label class="label-text">First Name:</label><br>
           <input class="input-css" type="text" v-model="formData.firstName" placeholder="Enter your First Name" required>
      </div><br>
      <div>
        <label class="label-text">Last Name:</label><br>
          <input class="input-css" type="text" v-model="formData.lastName" placeholder="Enter your Last Name" required>
      </div><br>
      <div>
      ...
      <div>
        <label class="label-text">Phone No. :</label><br>
            <input class="input-css" type="text" v-model="formData.mobile" placeholder="Enter your phone number" required>
      </div><br>
      <div>
