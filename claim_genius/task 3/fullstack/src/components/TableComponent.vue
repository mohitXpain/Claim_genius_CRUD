...
const props = defineProps(['formDataList', 'limit', 'page', 'totalPage', 'sortColumn', 'sortCommand']);
...
<div class="table-controls">
        ...
        <select id="entries" name="entries" @change="handleEntriesChange">
  ...
  <button @click="handleSort('first_name')" class="arrow-button arrow-up" v-else>&#9650;</button>
      ...
      <tbody>
        <tr v-if="formDataList.length === 0">
          <td colspan="6"><h2>No matching records found</h2></td>
        </tr>
